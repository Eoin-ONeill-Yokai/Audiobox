...
apt install -y --allow-downgrades --install-recommends {"winehq-$wine_variant","wine-$wine_variant","wine-$wine_variant-amd64","wine-$wine_variant-i386"}="$wine_version~$codename$suffix"
